...
+ (NSMutableDictionary *)handleUrlString:(NSString *)urlString{
    NSMutableDictionary *dic = [NSMutableDictionary dictionary];
    NSURL *url = [NSURL URLWithString:urlString];
    [dic setObject:[url scheme] forKey:@"scheme"];
    [dic setObject:[url host] forKey:@"host"];
    [dic setObject:[url port] forKey:@"port"];
    [dic setObject:[url path] forKey:@"path"];
    [dic setObject:[urlString substringFromIndex:10] forKey:@"webUrl"];
